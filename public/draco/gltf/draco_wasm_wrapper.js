var $jscomp = $jscomp || {}; $jscomp.scope = {}; $jscomp.arrayIteratorImpl = function (f) {
  let m = 0; return function () {
  ...
  const m = typeof Symbol !== 'undefined' && Symbol.iterator && f[Symbol.iterator]; return m ? m.call(f) : $jscomp.arrayIterator(f)
}
$jscomp.getGlobal = function (f) {
  return typeof window !== 'undefined' && window === f ? f : typeof global !== 'undefined' && global != null ? global : f
}; $jscomp.global = $jscomp.getGlobal(this); $jscomp.ASSUME_ES5 = !1; $jscomp.ASSUME_NO_NATIVE_MAP = !1; $jscomp.ASSUME_NO_NATIVE_SET = !1; $jscomp.SIMPLE_FROUND_POLYFILL = !1; $jscomp.defineProperty = $jscomp.ASSUME_ES5 || typeof Object.defineProperties === 'function' ? Object.defineProperty : function (f, m, v) {
  f != Array.prototype && f != Object.prototype && (f[m] = v.value)
}
$jscomp.polyfill = function (f, m, v, t) {
  if (m) {
    v = $jscomp.global; f = f.split('.'); for (t = 0; t < f.length - 1; t++) {
      const h = f[t]; h in v || (v[h] = {}); v = v[h]
    } f = f[f.length - 1]; t = v[f]; m = m(t); m != t && m != null && $jscomp.defineProperty(v, f, {configurable: !0, writable: !0, value: m})
  }
...
$jscomp.polyfill('Promise', function (f) {
  ...
  function v(e) {
  ...
  } if (f && !$jscomp.FORCE_POLYFILL_PROMISE) {
    return f
  } m.prototype.asyncExecute = function (e) {
    if (this.batch_ == null) {
      this.batch_ = []; const l = this; this.asyncExecuteFunction(function () {
        l.executeBatch_()
      })
    } this.batch_.push(e)
  }; const t = $jscomp.global.setTimeout; m.prototype.asyncExecuteFunction = function (e) {
    t(e, 0)
  }; m.prototype.executeBatch_ = function () {
    for (; this.batch_ && this.batch_.length;) {
      const e =
        this.batch_; this.batch_ = []; for (let l = 0; l < e.length; ++l) {
          const f = e[l]; e[l] = null; try {
            f()
          } catch (z) {
            this.asyncThrow_(z)
          }
    ...
    this.state_ = 0; this.result_ = void 0; this.onSettledCallbacks_ = []; const l = this.createResolveAndReject_(); try {
    ...
    if (e === this) {
      ...
      a: switch (typeof e) {
        case 'object': var l = e != null; break a; case 'function': l = !0; break a; default: l = !1
    ...
    } this.state_ = e; this.result_ = l; this.executeOnSettledCallbacks_()
  }; h.prototype.executeOnSettledCallbacks_ = function () {
    if (this.onSettledCallbacks_ != null) {
      for (let e = 0; e < this.onSettledCallbacks_.length; ++e) {
        X.asyncExecute(this.onSettledCallbacks_[e])
      }
      this.onSettledCallbacks_ = null
    }
  }; var X = new m; h.prototype.settleSameAsPromise_ = function (e) {
    const l = this.createResolveAndReject_(); e.callWhenSettled_(l.resolve, l.reject)
  }; h.prototype.settleSameAsThenable_ = function (e, l) {
    const f = this.createResolveAndReject_(); try {
     ...
     */
    function l(e, f) {
      return typeof e === 'function' ? function (f) {
        try {
          m(e(f))
        } catch (p) {
          v(p)
    ...
    } let m; let v; const t = new h(function (e, f) {
      m = e; v = f
    }); this.callWhenSettled_(l(e, m), l(f, v)); return t
  }
  h.prototype.catch = function (e) {
    ...
    function l() {
      switch (h.state_) {
        case 1: e(h.result_); break; case 2: f(h.result_); break; default: throw Error(`Unexpected state: ${h.state_}`)
      }
    } var h = this; this.onSettledCallbacks_ == null ? X.asyncExecute(l) : this.onSettledCallbacks_.push(l)
  }; h.resolve = v; h.reject = function (e) {
    return new h(function (f, h) {
      h(e)
    })
  }; h.race = function (e) {
    return new h(function (f, h) {
      for (let l = $jscomp.makeIterator(e), m = l.next(); !m.done; m = l.next()) {
        v(m.value).callWhenSettled_(f,
          h)
      }
    })
  }; h.all = function (e) {
    const f = $jscomp.makeIterator(e); let m = f.next(); return m.done ? v([]) : new h(function (e, h) {
      /**
       *
       */
      function l(f) {
        ...
        t.push(void 0), z++, v(m.value).callWhenSettled_(l(t.length - 1), h), m = f.next()
      } while (!m.done)
    })
  }; return h
}, 'es6', 'es3')
const DracoDecoderModule = function () {
  let f = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : void 0; typeof __filename !== 'undefined' && (f = f || __filename); return function (m) {
    ...
    function t(a, c) {
      ...
      */
    function h(a, c, b) {
      let d = c + b; for (b = c; a[b] && !(b >= d);) {
        ++b
      } if (b - c > 16 && a.subarray && xa) {
        return xa.decode(a.subarray(c, b))
      } for (d = ''; c < b;) {
        let k = a[c++]; if (k & 128) {
          const e = a[c++] & 63; if ((k & 224) == 192) {
            d += String.fromCharCode((k &
              31) << 6 | e)
          } else {
            const f = a[c++] & 63; k = (k & 240) == 224 ? (k & 15) << 12 | e << 6 | f : (k & 7) << 18 | e << 12 | f << 6 | a[c++] & 63; k < 65536 ? d += String.fromCharCode(k) : (k -= 65536, d += String.fromCharCode(55296 | k >> 10, 56320 | k & 1023))
          }
        } else {
          d += String.fromCharCode(k)
        }
    ...
    function S(k) {
      for (; k.length > 0;) {
        const c = k.shift(); if (typeof c === 'function') {
          c()
        } else {
          const b = c.func; typeof b === 'number' ? void 0 === c.arg ? a.dynCall_v(b) : a.dynCall_vi(b, c.arg) : b(void 0 === c.arg ? null : c.arg)
        }
      }
    }/**
} *
    ...
    function z(k) {
      if (a.onAbort) {
        a.onAbort(k)
      } k += ''; ya(k); Y(k); za = !0; throw new WebAssembly.RuntimeError(`abort(${k}). Build with -s ASSERTIONS=1 for more info.`)
    }/**
} *
}
      */
...
aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    ...
    function wa() {
      ...
      */
    function Ma() {
      return da || !ea && !Z || typeof fetch !== 'function' ? new Promise(function (a, c) {
        a(wa())
    ...
    function ba() {
      if (!ba.strings) {
        const a = {
          USER: 'web_user',
          LOGNAME: 'web_user', PATH: '/', PWD: '/', HOME: '/home/web_user', LANG: `${(typeof navigator === 'object' && navigator.languages && navigator.languages[0] || 'C').replace('-', '_')}.UTF-8`, _: na
        }; let c; for (c in Aa) {
          a[c] = Aa[c]
        } const b = []; for (c in a) {
          b.push(`${c}=${a[c]}`)
    ...
    function ma(k) {
      ...
      function c() {
        if (!fa && (fa = !0, !za)) {
          Ba = !0; S(Ca); S(Da); if (a.onRuntimeInitialized) {
        ...
        } S(Fa); aa > 0 || (a.setStatus ? (a.setStatus('Running...'), setTimeout(function () {
          setTimeout(function () {
            a.setStatus('')
          }, 1); c()
        }, 1)) : c())
...
fffffffffffffff
    ...
    function u(a) {
      ...
      */
    function N(a, c) {
      const b = u(c); let d = b[a]; if (d) {
        return d
      } d = Object.create((c || p).prototype); d.ptr = a; return b[a] = d
    }/**
} *
}
      */
      ...
      if (typeof a === 'string') {
        for (var c = 0, b = 0; b < a.length; ++b) {
          ...
          d = b + d - 1; for (let k = 0; k < a.length; ++k) {
            let e = a.charCodeAt(k); if (e >= 55296 && e <= 57343) {
              const f = a.charCodeAt(++k); e = 65536 + ((e & 1023) << 10) | f & 1023
            } if (e <= 127) {
              if (b >= d) {
                break
              } c[b++] = e
    ...
    function x() {
      ...
      */
    function A() {
      this.ptr = Oa(); u(A)[this.ptr] = this
    }/**
} *
}
      */
    function B() {
      this.ptr = Pa(); u(B)[this.ptr] = this
    }/**
} *
}
      */
    function C() {
      this.ptr = Qa(); u(C)[this.ptr] = this
    }/**
} *
}
      */
    function D() {
      this.ptr = Ra(); u(D)[this.ptr] = this
    }/**
} *
}
      */
    function E() {
      this.ptr = Sa(); u(E)[this.ptr] = this
    }/**
} *
}
      */
    function q() {
      this.ptr = Ta(); u(q)[this.ptr] = this
    }/**
} *
}
      */
    function J() {
      this.ptr = Ua(); u(J)[this.ptr] = this
    }/**
} *
}
      */
    function w() {
      this.ptr = Va(); u(w)[this.ptr] = this
    }/**
} *
}
      */
    function F() {
      ...
      */
    function r() {
      this.ptr = Xa(); u(r)[this.ptr] = this
    }/**
} *
}
      */
    function G() {
      this.ptr = Ya(); u(G)[this.ptr] = this
    }/**
} *
}
      */
    function H() {
      this.ptr = Za(); u(H)[this.ptr] = this
    }/**
} *
}
      */
    function O() {
      this.ptr = $a(); u(O)[this.ptr] = this
    }/**
} *
}
      */
    function K() {
      this.ptr = ab(); u(K)[this.ptr] = this
    }/**
} *
}
      */
    function g() {
      this.ptr = bb(); u(g)[this.ptr] = this
    }/**
} *
}
      */
    function y() {
      this.ptr = cb(); u(y)[this.ptr] = this
    }/**
} *
}
      */
    ...
    function L() {
      ...
      Ga = !0; if (Ha && typeof a.onModuleLoaded === 'function') {
        a.onModuleLoaded(a)
      }
    }; a.onModuleParsed = function () {
      Ha = !0; if (Ga && typeof a.onModuleLoaded === 'function') {
        a.onModuleLoaded(a)
      }
    }; a.isVersionSupported = function (a) {
      if (typeof a !== 'string') {
        return !1
      } a = a.split('.'); return a.length < 2 || a.length > 3 ? !1 : a[0] == 1 && a[1] >= 0 && a[1] <= 3 ? !0 : a[0] != 0 || a[1] > 10 ? !1 : !0
    }; let ha = {}; let W; for (W in a) {
      a.hasOwnProperty(W) && (ha[W] = a[W])
    } var na = './this.program'
    var ea = !1; var Z = !1; let oa = !1; let fb = !1; let Ia = !1; ea = typeof window === 'object'; Z = typeof importScripts === 'function'; oa = (fb = typeof process === 'object' && typeof process.versions === 'object' && typeof process.versions.node === 'string') && !ea && !Z; Ia = !ea && !oa && !Z; var M = ''; let pa; let qa; if (oa) {
      M = `${__dirname}/`; var ra = function (a, c) {
        pa || (pa = require('fs')); qa || (qa = require('path')); a = qa.normalize(a); return pa.readFileSync(a, c ? null : 'utf8')
      }; var la = function (a) {
        a = ra(a, !0); a.buffer || (a = new Uint8Array(a)); t(a.buffer); return a
      }; process.argv.length > 1 &&
        (na = process.argv[1].replace(/\\/g, '/')); process.argv.slice(2); process.on('uncaughtException', function (a) {
          throw a
        }); process.on('unhandledRejection', z); a.inspect = function () {
          return '[Emscripten Module object]'
        }
    } else if (Ia) {
      typeof read !== 'undefined' && (ra = function (a) {
        return read(a)
      }), la = function (a) {
        if (typeof readbuffer === 'function') {
          return new Uint8Array(readbuffer(a))
        } a = read(a, 'binary'); t(typeof a === 'object'); return a
      }, typeof print !== 'undefined' && (typeof console === 'undefined' && (console = {}), console.log = print,
        console.warn = console.error = typeof printErr !== 'undefined' ? printErr : print)
    } else if (ea || Z) {
      Z ? M = self.location.href : document.currentScript && (M = document.currentScript.src), f && (M = f), M = M.indexOf('blob:') !== 0 ? M.substr(0, M.lastIndexOf('/') + 1) : '', ra = function (a) {
        const c = new XMLHttpRequest; c.open('GET', a, !1); c.send(null); return c.responseText
      }, Z && (la = function (a) {
        const c = new XMLHttpRequest; c.open('GET', a, !1); c.responseType = 'arraybuffer'; c.send(null); return new Uint8Array(c.response)
      })
    } var ya = a.print || console.log.bind(console)
    var Y = a.printErr || console.warn.bind(console); for (W in ha) {
      ha.hasOwnProperty(W) && (a[W] = ha[W])
    } ha = null; a.thisProgram && (na = a.thisProgram); let da; a.wasmBinary && (da = a.wasmBinary); typeof WebAssembly !== 'object' && Y('no native wasm support detected'); let ia; const gb = new WebAssembly.Table({initial: 293, maximum: 293, element: 'anyfunc'}); var za = !1; var xa = typeof TextDecoder !== 'undefined' ? new TextDecoder('utf8') : void 0; typeof TextDecoder !== 'undefined' && new TextDecoder('utf-16le'); let T; let ca; let P; let Ja = a.TOTAL_MEMORY || 16777216; if (ia = a.wasmMemory ?
      a.wasmMemory : new WebAssembly.Memory({initial: Ja / 65536})) {
      var ka = ia.buffer
    } Ja = ka.byteLength; l(ka); P[3416] = 5256704; var Fa = []; var Ca = []; var Da = []; var Ea = []; var Ba = !1; var aa = 0; let sa = null; let ja = null; a.preloadedImages = {}; a.preloadedAudios = {}; var U = 'draco_decoder.wasm'; va(U) || (U = v(U)); Ca.push({
      func: function () {
        hb()
      }
    }); var Aa = {}; var R = {
      buffers: [null, [], []], printChar: function (a, c) {
        const b = R.buffers[a]; c === 0 || c === 10 ? ((a === 1 ? ya : Y)(h(b, 0)), b.length = 0) : b.push(c)
      }, varargs: 0, get: function (a) {
        R.varargs += 4; return P[R.varargs - 4 >> 2]
      }, getStr: function () {
        return X(R.get())
      },
      get64: function () {
        const a = R.get(); R.get(); return a
      }, getZero: function () {
        R.get()
      }
    }; const Ka = {
      __cxa_allocate_exception: function (a) {
        ...
        'uncaught_exception' in ta ? ta.uncaught_exceptions++ : ta.uncaught_exceptions = 1; throw a
      }, abort: function () {
        z()
        ...
        if (a > 2147418112) {
          ...
          c = c <=
            536870912 ? e(2 * c, 65536) : Math.min(e((3 * c + 2147483648) / 4, 65536), 2147418112)
        } a: {
          try {
            ia.grow(c - ka.byteLength + 65535 >> 16); l(ia.buffer); var b = 1; break a
          } catch (d) { } b = void 0
        } return b ? !0 : !1
      }, environ_get: function (a, c) {
        let b = 0; ba().forEach(function (d, e) {
          let f = c + b; e = P[a + 4 * e >> 2] = f; for (f = 0; f < d.length; ++f) {
            T[e++ >> 0] = d.charCodeAt(f)
          } T[e >> 0] = 0; b += d.length + 1
        }); return 0
      }, environ_sizes_get: function (a, c) {
        const b = ba(); P[a >> 2] = b.length; let d = 0; b.forEach(function (a) {
          d += a.length + 1
        }); P[c >> 2] = d; return 0
      }, fd_close: function (a) {
        return 0
      ...
      }, memory: ia, setTempRet0: function (a) { }, table: gb
    }; const La = function () {
      /**
       *
       */
      function e(c, b) {
        a.asm = c.exports; aa--; a.monitorRunDependencies && a.monitorRunDependencies(aa); aa == 0 && (sa !== null && (clearInterval(sa), sa = null), ja && (c = ja, ja = null, c()))
      }/**
} *
}
        */
      ...
      function b(a) {
        return Ma().then(function (a) {
          ...
          Y(`failed to asynchronously prepare wasm: ${a}`); z(a)
        })
      } var d = {env: Ka, wasi_unstable: Ka}; aa++; a.monitorRunDependencies && a.monitorRunDependencies(aa); if (a.instantiateWasm) {
        try {
        ...
        if (da || typeof WebAssembly.instantiateStreaming !== 'function' || va(U) || typeof fetch !== 'function') {
          return b(c)
        } fetch(U,
          {credentials: 'same-origin'}).then(function (a) {
            return WebAssembly.instantiateStreaming(a, d).then(c, function (a) {
              Y(`wasm streaming compile failed: ${a}`); Y('falling back to ArrayBuffer instantiation'); b(c)
            })
          })
      })(); return {}
    }(); a.asm = La; var hb = a.___wasm_call_ctors = function () {
    ...
    const Qc = a._emscripten_bind_VoidPtr___destroy___0 = function () {
      ...
      }; const xd = a._emscripten_enum_draco_GeometryAttribute_Type_COLOR =
        function () {
    ...
    a.dynCall_viiii = function () {
      ...
      if (fa) {
        ...
        const c = a.onRuntimeInitialized; a.onRuntimeInitialized = function () {
          c && c(); e(a)
        }
      } return a
    }; ja = function c() {
      fa || ma(); fa || (ja = c)
    }; a.run = ma; if (a.preInit) {
      for (typeof a.preInit === 'function' && (a.preInit = [a.preInit]); a.preInit.length > 0;) {
        a.preInit.pop()()
      }
    } ma(); p.prototype = Object.create(p.prototype); p.prototype.constructor = p; p.prototype.__class__ = p; p.__cache__ = {}; a.WrapperObject = p; a.getCache = u; a.wrapPointer = N; a.castObject = function (a, b) {
      return N(a.ptr, b)
    }; a.NULL = N(0); a.destroy = function (a) {
      if (!a.__destroy__) {
      ...
      buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare: function () {
        if (n.needed) {
          for (let c = 0; c < n.temps.length; c++) {
            a._free(n.temps[c])
          } n.temps.length = 0; a._free(n.buffer); n.buffer = 0; n.size += n.needed; n.needed = 0
        } n.buffer || (n.size += 128, n.buffer = a._malloc(n.size), t(n.buffer)); n.pos = 0
      }, alloc: function (c, b) {
        ...
        switch (b.BYTES_PER_ELEMENT) {
          case 2: d >>= 1; break; case 4: d >>= 2; break; case 8: d >>= 3
        } for (let c = 0; c < a.length; c++) {
          b[d + c] = a[c]
        }
      }
    }; x.prototype = Object.create(p.prototype); x.prototype.constructor = x; x.prototype.__class__ = x; x.__cache__ = {}; a.Status = x; x.prototype.code = x.prototype.code = function () {
      return jb(this.ptr)
      ...
      x.prototype.error_msg = function () {
        ...
        mb(this.ptr)
      }; A.prototype = Object.create(p.prototype); A.prototype.constructor = A; A.prototype.__class__ = A; A.__cache__ = {}; a.DracoUInt16Array = A; A.prototype.GetValue = A.prototype.GetValue = function (a) {
        const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return nb(c, a)
      }; A.prototype.size = A.prototype.size = function () {
        return ob(this.ptr)
      }; A.prototype.__destroy__ = A.prototype.__destroy__ = function () {
        pb(this.ptr)
      }
    B.prototype = Object.create(p.prototype); B.prototype.constructor = B; B.prototype.__class__ = B; B.__cache__ = {}; a.PointCloud = B; B.prototype.num_attributes = B.prototype.num_attributes = function () {
      return qb(this.ptr)
    }; B.prototype.num_points = B.prototype.num_points = function () {
      return rb(this.ptr)
    }; B.prototype.__destroy__ = B.prototype.__destroy__ = function () {
      sb(this.ptr)
    }; C.prototype = Object.create(p.prototype); C.prototype.constructor = C; C.prototype.__class__ = C; C.__cache__ = {}; a.DracoUInt8Array = C; C.prototype.GetValue =
      C.prototype.GetValue = function (a) {
        const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return tb(c, a)
      }; C.prototype.size = C.prototype.size = function () {
        return ub(this.ptr)
      }; C.prototype.__destroy__ = C.prototype.__destroy__ = function () {
        vb(this.ptr)
      }; D.prototype = Object.create(p.prototype); D.prototype.constructor = D; D.prototype.__class__ = D; D.__cache__ = {}; a.DracoUInt32Array = D; D.prototype.GetValue = D.prototype.GetValue = function (a) {
        const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return wb(c, a)
      }; D.prototype.size = D.prototype.size =
        function () {
          return xb(this.ptr)
        }; D.prototype.__destroy__ = D.prototype.__destroy__ = function () {
          yb(this.ptr)
        }; E.prototype = Object.create(p.prototype); E.prototype.constructor = E; E.prototype.__class__ = E; E.__cache__ = {}; a.AttributeOctahedronTransform = E; E.prototype.InitFromAttribute = E.prototype.InitFromAttribute = function (a) {
          const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return !!zb(c, a)
        }; E.prototype.quantization_bits = E.prototype.quantization_bits = function () {
          return Ab(this.ptr)
        }; E.prototype.__destroy__ = E.prototype.__destroy__ =
          function () {
            Bb(this.ptr)
          }; q.prototype = Object.create(p.prototype); q.prototype.constructor = q; q.prototype.__class__ = q; q.__cache__ = {}; a.PointAttribute = q; q.prototype.size = q.prototype.size = function () {
            return Cb(this.ptr)
            ...
            q.prototype.num_components = function () {
              ...
              Lb(this.ptr)
            }; J.prototype = Object.create(p.prototype); J.prototype.constructor =
              J; J.prototype.__class__ = J; J.__cache__ = {}; a.AttributeTransformData = J; J.prototype.transform_type = J.prototype.transform_type = function () {
                return Mb(this.ptr)
              }; J.prototype.__destroy__ = J.prototype.__destroy__ = function () {
                Nb(this.ptr)
              }; w.prototype = Object.create(p.prototype); w.prototype.constructor = w; w.prototype.__class__ = w; w.__cache__ = {}; a.AttributeQuantizationTransform = w; w.prototype.InitFromAttribute = w.prototype.InitFromAttribute = function (a) {
                const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return !!Ob(c, a)
              }
    w.prototype.quantization_bits = w.prototype.quantization_bits = function () {
      ...
      const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return Qb(c, a)
    }; w.prototype.range = w.prototype.range = function () {
      return Rb(this.ptr)
    }; w.prototype.__destroy__ = w.prototype.__destroy__ = function () {
      Sb(this.ptr)
    }; F.prototype = Object.create(p.prototype); F.prototype.constructor = F; F.prototype.__class__ = F; F.__cache__ = {}; a.DracoInt8Array = F; F.prototype.GetValue = F.prototype.GetValue =
      function (a) {
        const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return Tb(c, a)
        ...
        Vb(this.ptr)
      }; r.prototype = Object.create(p.prototype); r.prototype.constructor = r; r.prototype.__class__ = r; r.__cache__ = {}; a.MetadataQuerier = r; r.prototype.HasEntry = r.prototype.HasEntry = function (a, b) {
        const c = this.ptr; n.prepare(); a && typeof a === 'object' && (a = a.ptr); b = b && typeof b === 'object' ? b.ptr : V(b); return !!Wb(c,
          a, b)
      }; r.prototype.GetIntEntry = r.prototype.GetIntEntry = function (a, b) {
        const c = this.ptr; n.prepare(); a && typeof a === 'object' && (a = a.ptr); b = b && typeof b === 'object' ? b.ptr : V(b); return Xb(c, a, b)
      }; r.prototype.GetIntEntryArray = r.prototype.GetIntEntryArray = function (a, b, d) {
        const c = this.ptr; n.prepare(); a && typeof a === 'object' && (a = a.ptr); b = b && typeof b === 'object' ? b.ptr : V(b); d && typeof d === 'object' && (d = d.ptr); Yb(c, a, b, d)
        ...
        const c = this.ptr; n.prepare(); a && typeof a === 'object' && (a = a.ptr); b = b && typeof b === 'object' ? b.ptr : V(b); return X($b(c, a, b))
      }; r.prototype.NumEntries = r.prototype.NumEntries = function (a) {
        const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return ac(c, a)
        ...
        cc(this.ptr)
      }; G.prototype = Object.create(p.prototype); G.prototype.constructor = G; G.prototype.__class__ = G; G.__cache__ = {}; a.DracoInt16Array = G; G.prototype.GetValue = G.prototype.GetValue = function (a) {
        const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return dc(c, a)
      }; G.prototype.size = G.prototype.size = function () {
        return ec(this.ptr)
      }; G.prototype.__destroy__ = G.prototype.__destroy__ = function () {
        fc(this.ptr)
      }; H.prototype =
        Object.create(p.prototype); H.prototype.constructor = H; H.prototype.__class__ = H; H.__cache__ = {}; a.DracoFloat32Array = H; H.prototype.GetValue = H.prototype.GetValue = function (a) {
          const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return gc(c, a)
        }; H.prototype.size = H.prototype.size = function () {
          return hc(this.ptr)
        }; H.prototype.__destroy__ = H.prototype.__destroy__ = function () {
          ic(this.ptr)
        }; O.prototype = Object.create(p.prototype); O.prototype.constructor = O; O.prototype.__class__ = O; O.__cache__ = {}; a.GeometryAttribute = O; O.prototype.__destroy__ =
          O.prototype.__destroy__ = function () {
            jc(this.ptr)
          }; K.prototype = Object.create(p.prototype); K.prototype.constructor = K; K.prototype.__class__ = K; K.__cache__ = {}; a.DecoderBuffer = K; K.prototype.Init = K.prototype.Init = function (a, b) {
            const c = this.ptr; n.prepare(); if (typeof a === 'object' && typeof a === 'object') {
              const e = n.alloc(a, T); n.copy(a, T, e); a = e
            } b && typeof b === 'object' && (b = b.ptr); kc(c, a, b)
          }; K.prototype.__destroy__ = K.prototype.__destroy__ = function () {
            lc(this.ptr)
          }; g.prototype = Object.create(p.prototype); g.prototype.constructor =
            g; g.prototype.__class__ = g; g.__cache__ = {}; a.Decoder = g; g.prototype.GetEncodedGeometryType = g.prototype.GetEncodedGeometryType = function (a) {
              const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return mc(c, a)
            }; g.prototype.DecodeBufferToPointCloud = g.prototype.DecodeBufferToPointCloud = function (a, b) {
              const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); return N(nc(c, a, b), x)
              ...
              const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); return pc(c, a, b)
            }; g.prototype.GetAttributeIdByName = g.prototype.GetAttributeIdByName = function (a, b) {
              const c = this.ptr; n.prepare(); a && typeof a === 'object' && (a = a.ptr); b = b && typeof b === 'object' ? b.ptr : V(b); return qc(c, a, b)
            }; g.prototype.GetAttributeIdByMetadataEntry = g.prototype.GetAttributeIdByMetadataEntry =
              function (a, b, d) {
                const c = this.ptr; n.prepare(); a && typeof a === 'object' && (a = a.ptr); b = b && typeof b === 'object' ? b.ptr : V(b); d = d && typeof d === 'object' ? d.ptr : V(d); return rc(c, a, b, d)
              }; g.prototype.GetAttribute = g.prototype.GetAttribute = function (a, b) {
                const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); return N(sc(c, a, b), q)
                ...
                const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); return N(uc(c, a), L)
              }; g.prototype.GetAttributeMetadata = g.prototype.GetAttributeMetadata = function (a, b) {
                const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); return N(vc(c, a, b), L)
                ...
                const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); return xc(c, a, b)
              }; g.prototype.GetTrianglesUInt16Array = g.prototype.GetTrianglesUInt16Array = function (a, b, d) {
                const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!yc(c, a, b, d)
              }; g.prototype.GetTrianglesUInt32Array = g.prototype.GetTrianglesUInt32Array =
                function (a, b, d) {
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!zc(c, a, b, d)
                }; g.prototype.GetAttributeFloat = g.prototype.GetAttributeFloat = function (a, b, d) {
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!Ac(c, a, b, d)
                  ...
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!Cc(c, a, b, d)
                  ...
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!Ec(c, a, b, d)
                  ...
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!Gc(c, a, b, d)
                }; g.prototype.GetAttributeInt32ForAllPoints = g.prototype.GetAttributeInt32ForAllPoints = function (a, b, d) {
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!Hc(c,
                    a, b, d)
                }; g.prototype.GetAttributeUInt32ForAllPoints = g.prototype.GetAttributeUInt32ForAllPoints = function (a, b, d) {
                  const c = this.ptr; a && typeof a === 'object' && (a = a.ptr); b && typeof b === 'object' && (b = b.ptr); d && typeof d === 'object' && (d = d.ptr); return !!Ic(c, a, b, d)
                  ...
                  const b = this.ptr; a && typeof a === 'object' && (a = a.ptr); Kc(b, a)
                }; g.prototype.__destroy__ = g.prototype.__destroy__ = function () {
                  Lc(this.ptr)
                }; y.prototype = Object.create(p.prototype); y.prototype.constructor = y; y.prototype.__class__ = y; y.__cache__ = {}; a.Mesh = y; y.prototype.num_faces = y.prototype.num_faces = function () {
                  return Mc(this.ptr)
                  ...
                  function () {
                    ...
                    Pc(this.ptr)
                  }; Q.prototype = Object.create(p.prototype); Q.prototype.constructor = Q; Q.prototype.__class__ = Q; Q.__cache__ = {}; a.VoidPtr = Q; Q.prototype.__destroy__ = Q.prototype.__destroy__ = function () {
                    Qc(this.ptr)
                  }; I.prototype = Object.create(p.prototype); I.prototype.constructor = I; I.prototype.__class__ = I; I.__cache__ = {}; a.DracoInt32Array = I; I.prototype.GetValue =
                    I.prototype.GetValue = function (a) {
                      const b = this.ptr; a && typeof a === 'object' && (a = a.ptr); return Rc(b, a)
                    }; I.prototype.size = I.prototype.size = function () {
                      return Sc(this.ptr)
                    }; I.prototype.__destroy__ = I.prototype.__destroy__ = function () {
                      Tc(this.ptr)
                    }; L.prototype = Object.create(p.prototype); L.prototype.constructor = L; L.prototype.__class__ = L; L.__cache__ = {}; a.Metadata = L; L.prototype.__destroy__ = L.prototype.__destroy__ = function () {
                      Uc(this.ptr)
                    }; (function () {
                      /**
                       *
                    ...
                    })(); if (typeof a.onModuleParsed === 'function') {
                      a.onModuleParsed()
                    } return m
  }
}(); typeof exports === 'object' && typeof module === 'object' ? module.exports = DracoDecoderModule : typeof define === 'function' && define.amd ? define([], function () {
